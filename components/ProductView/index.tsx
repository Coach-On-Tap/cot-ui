...
const productsProductViewChartData = [
  {
    name: "Jan",
    amt: 2400,
  },
    ...
    if (payload && payload.length) {
      return (
        <div className="chart-tooltip">
          <div className="mb-0.5 text-caption text-t-light/80">{label}</div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar
                ...
                radius={8}
              >
                {productsProductViewChartData.map((entry, index) => (
                  <Cell
                    key={`cell-${index}`}
                    fill={
                    ...
                    fillOpacity={getMinValues.includes(entry.amt) ? 1 : 0.4}
                  />
                ))}
              </Bar>
            </BarChart>
